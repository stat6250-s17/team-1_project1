...
Methodology: Can use PROC MEANS to get the average of overall rating for each "Hospital Ownership" Type
...
Limitations: Doesn't take into account porportion of number of hospitals in each state.
Possible Follow-up Steps:;
